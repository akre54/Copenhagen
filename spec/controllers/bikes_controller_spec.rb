  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bike as @bike" do
        ...
        post :create, {:bike => { "color" => "invalid value" }}, valid_session
        assigns(:bike).should be_a_new(Bike)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bike" do
        ...
        Bike.any_instance.should_receive(:update_attributes).with({ "color" => "MyString" })
        put :update, {:id => bike.to_param, :bike => { "color" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bike as @bike" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bike.any_instance.stub(:save).and_return(false)
        put :update, {:id => bike.to_param, :bike => { "color" => "invalid value" }}, valid_session
        assigns(:bike).should eq(bike)
      end
